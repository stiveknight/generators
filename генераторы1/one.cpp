...
vector <long long> add(map <string, string> params) {
	...
	while (k >= j) {
		cout << "Ќеверно заданы k, j (k должно быть меньше j)" << endl;
...
vector <long long> five_p(map <string, string> params) {
	...
	while (!(q1 < q2 && q2 < q3 && q3 < p)) {
		cout << "Ќеверно заданы p, q1, q2, q3 (q1<q2<q3<p)" << endl;
...
vector <long long> lfsr(map <string, string> params) {
	...
	while (x < 5000000000) {
		cout << "Ќедостаточно большой x" << endl;
		cout << "x = "; cin >> x; cout << endl;
	}

	while (a < 5000000000) {
		cout << "Ќедостаточно больша€ a" << endl;
...
vector <long long> mt(map <string, string> params) {
	...
	while (!(q < p)) {
		cout << "Ќеверно заданы q, p (q<p)" << endl;
		cout << "p = "; cin >> p; cout << endl;
		cout << "q = "; cin >> q; cout << endl;
	}

	while (!(r < w)) {
		cout << "Ќеверно заданы r, w (r<w)" << endl;
		cout << "p = "; cin >> p; cout << endl;
		cout << "q = "; cin >> q; cout << endl;
	}
	...
	for (int i = 0; i < p; i++) { //генераци€ p штук X
		tmp.clear();
		for (int j = 0; j < w; j++) {
...
vector <long long> rc4(map <string, string> params) {
	...
	while (k < 50000000000) {
		cout << "Ќедостаточно большой k" << endl;
		cout << "k = "; cin >> k; cout << endl;
	}
...
vector <long long> rsa(map <string, string> params) {
	...
	while (!(is_simple(q, simple) && is_simple(p, simple))) {
		cout << "Ќеверно заданы q, p (q и p должны быть простыми > 500)" << endl;
		cout << "p = "; cin >> p; cout << endl;
		cout << "q = "; cin >> q; cout << endl;
	}
...
vector <long long> bbs(map <string, string> params) {
	...
	while (!((q - 3) % 4 == 0 && (p - 3) % 4 == 0)) {
		cout << "Ќеверно заданы q, p (q и p должны быть простыми сравнимыми с 3 по модулю 4)" << endl;
		cout << "p = "; cin >> p; cout << endl;
		cout << "q = "; cin >> q; cout << endl;
	}
